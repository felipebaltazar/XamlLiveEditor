namespace LiveEditor.Api.Infrastructure.Helpers
{
    public class Constants
    {
        ...
        {
            /// <remarks/>
            public const string TITLE = "Api LiveEditor";
            /// <remarks/>
            public const string VERSION = "v1";
            /// <remarks/>
            public const string DESCRIPTION = "Api REST, ASP.NET Core, de controle e manipulação de informações do aplicativo LiveEditor ";

            /// <remarks/>
            public static class Contact
            {
                /// <remarks/>
                public const string NAME = "LiveEditor";
                /// <remarks/>
